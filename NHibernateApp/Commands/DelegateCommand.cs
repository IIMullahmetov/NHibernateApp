...
namespace NHibernateApp.Commands
{
    /// <summary>
    ...
    public class DelegateCommand : ICommand
    {
		...
		/// </summary>
		public void Execute() => _executeMethod?.Invoke();
		...
		/// </summary>
		protected virtual void OnCanExecuteChanged() => CommandManagerHelper.CallWeakReferenceHandlers(_canExecuteChangedHandlers);
